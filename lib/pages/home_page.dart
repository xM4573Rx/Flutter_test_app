...
import 'package:test_app/widgets/home_app_bar_title.dart';
import 'package:test_app/widgets/product_detail.dart';
import 'package:test_app/widgets/summary_card.dart';
...
class _HomePageState extends State<HomePage> {
  var buttonStyleInactive = ElevatedButton.styleFrom(
    ...
    shadowColor: TestColors.brandLightColor,
  );
  var buttonStyleActive = ElevatedButton.styleFrom(
    backgroundColor: TestColors.brandSecondaryColor,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: TestColors.brandLightColor,
        title: Padding(
          padding: const EdgeInsets.fromLTRB(16.0, 45.0, 16.0, 12.0),
